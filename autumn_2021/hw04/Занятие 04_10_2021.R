...
# Экологические переменные: 5-бальные оценки степени хищничества животных (Pred), 
# меры защищенности их места для сна (Exp): от глубокой норы до полно  стью открытого пространства, 
# и показателя риска (Danger) на основе  логической комбинации Pred и Exp
