...
file <- "C:\\Users\\antpl_0n4duwv\\OneDrive\\Документы\\учеба\\5 семестр\\прак\\08_11_2021\\SparrowsElphick.txt"
Sparrows <- read.table(file = file, header = TRUE)
...
file <- "C:\\Users\\antpl_0n4duwv\\OneDrive\\Документы\\учеба\\5 семестр\\прак\\08_11_2021\\wader.txt"
Waders <- read.table(file = file, header = TRUE)
Time <- seq(1, 25)
